...
dash_demux_suite (void)
{
  ...
  tcase_add_unchecked_fixture (tc_basicTest, gst_adaptive_demux_test_setup,
      ...
      tcase_add_unchecked_fixture (tc_basicTests,
          gst_adaptive_demux_test_setup, gst_adaptive_demux_test_teardown);
      tcase_add_unchecked_fixture (tc_liveTests,
          gst_adaptive_demux_test_setup, gst_adaptive_demux_test_teardown);
      suite_add_tcase (s, tc_basicTests);
      suite_add_tcase (s, tc_liveTests); return s;
    }
